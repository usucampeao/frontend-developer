...
export class TypesService {
  ...
  public pokemonTypes: Map<number, { name: string, color: string, contrast: string }> = new Map([
    ...
    [2, { name: 'fighting', color: '#C03028', contrast: '#FFFFFF' }],
    [3, { name: 'flying', color: '#A890F0', contrast: '#FFFFFF' }],
    [4, { name: 'poison', color: '#A040A0', contrast: '#FFFFFF' }],
    [5, { name: 'ground', color: '#E0C068', contrast: '#FFFFFF' }],
    [6, { name: 'rock', color: '#B8A038', contrast: '#FFFFFF' }],
    [7, { name: 'bug', color: '#A8B820', contrast: '#FFFFFF' }],
    [8, { name: 'ghost', color: '#705898', contrast: '#FFFFFF' }],
    [9, { name: 'steel', color: '#B8B8D0', contrast: '#FFFFFF' }],
    ...
    [16, { name: 'dragon', color: '#7038F8', contrast: '#FFFFFF' }],
